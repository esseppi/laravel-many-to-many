        ...
        <form action="{{ route('admin.trades.store') }}" method="post">
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                    ...
                    <select placeholder="Prima Coin" id="coin1" name="baseCoin_id" class="form-control" value="select">
                        <option selected>Select a coin to sell</option>
                ...
                <div class="col-sm-6">
                    ...
                    <select placeholder="Seconda Coin" id="coin2" name="foreignCoin_id" class="form-control">
                        <option selected>Select a coin to buy</option>
                        @foreach ($coins as $coin)
                ...
                {{-- DATA --}}
                <div class="col-12">
                    <label for="date" class="form-label">Date <span class="text-muted">(Optional)</span></label>
